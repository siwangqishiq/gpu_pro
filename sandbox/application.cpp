...
void Application::onCreate(){
    ...
    appInstanceList.push_back(std::make_shared<AppGeometry>());
}
...
void Application::showDebugInfo(){
    ...
    int bannerWidth = 70;
    outputRect.left = purple::Engine::ScreenWidth - bannerWidth;
    outputRect.top = purple::Engine::ScreenHeight;
    outputRect.width = bannerWidth;
    outputRect.height = purple::Engine::ScreenHeight;
    paint.textGravity = purple::TopCenter;
